...
var _forwardRef = _interopRequireDefault(__webpack_require__(61));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_resolve_pathname__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_value_equal__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_tiny_warning__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_tiny_invariant__ = __webpack_require__(177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__generatePath__ = __webpack_require__(191);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__matchPath__ = __webpack_require__(192);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__withRouter__ = __webpack_require__(193);
...
var _camelize = _interopRequireDefault(__webpack_require__(63));
...
var _createWithBsPrefix = _interopRequireDefault(__webpack_require__(62));

var _divWithClassName = _interopRequireDefault(__webpack_require__(198));

var _CardContext = _interopRequireDefault(__webpack_require__(199));

var _CardImg = _interopRequireDefault(__webpack_require__(200));
...
var _Saved = __webpack_require__(212);
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/saved', component: _Saved2.default }),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Redirect__ = __webpack_require__(186);
// Written in this round about way for babel-transform-imports
...
var _CardColumns = __webpack_require__(98);
...
var _SafeAnchor = _interopRequireDefault(__webpack_require__(202));
...
var _assertThisInitialized2 = _interopRequireDefault(__webpack_require__(40));

var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(27));

var _react = _interopRequireDefault(__webpack_require__(0));

var _createChainedFunction = _interopRequireDefault(__webpack_require__(203));
...
var _FormGroup = _interopRequireDefault(__webpack_require__(205));

var _FormControl = _interopRequireDefault(__webpack_require__(206));

var _FormCheck = _interopRequireDefault(__webpack_require__(207));

var _FormLabel = _interopRequireDefault(__webpack_require__(210));

var _FormText = _interopRequireDefault(__webpack_require__(211));
...
var _FormContext = _interopRequireDefault(__webpack_require__(28));
...
var _Feedback = _interopRequireDefault(__webpack_require__(99));
...
var _FormCheckInput = _interopRequireDefault(__webpack_require__(208));

var _FormCheckLabel = _interopRequireDefault(__webpack_require__(209));
...
var _Col = _interopRequireDefault(__webpack_require__(100));
...
var Saved_Recipes = function (_React$Component2) {
  _inherits(Saved_Recipes, _React$Component2);

  function Saved_Recipes(props) {
    _classCallCheck(this, Saved_Recipes);

    var _this3 = _possibleConstructorReturn(this, (Saved_Recipes.__proto__ || Object.getPrototypeOf(Saved_Recipes)).call(this, props));
      ...
      fetch('/api/recipes').then(function (response) {
        if (response.ok) {
          response.json().then(function (data) {
            ...
            _this4.setState({ savedRecipes: data.records });
          });
        } else {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Row2.default,
          { style: { marginTop: '2rem' } },
          _react2.default.createElement(CardList, { recipes: this.state.savedRecipes })
        )
      );
    }
  }]);
